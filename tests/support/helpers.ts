...
export async function deleteTaskByHelp(request: APIRequestContext, taskName: string) {
    await request.delete(`${BASE_API}/helper/tasks/${taskName}`)
}
//garante que a etapa de cadastro via api foi realizada com sucesso retornando OK
